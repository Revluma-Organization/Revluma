...
export default function Dashboard({
  ...
  // Multi-attribution Dynamic Campaigns state - fetched from backend
  ...
  // Referral tracking database list state - fetched from backend
  ...
  // Notifications read/unread - fetched from backend
  ...
  // Leaderboard data from backend API
  const [leaderboardData, setLeaderboardData] = useState<LeaderboardUser[]>([]);

  // Fetch campaigns, referrals, notifications, and leaderboard on mount
  useEffect(() => {
  ...
  // Main navigation tab state for the dashboard
  const [activeTab, setActiveTab] = useState<'home' | 'referrals' | 'earnings' | 'campaigns' | 'copilot' | 'leaderboard' | 'assets' | 'training' | 'settings'>('home');
  ...
  // Combine API leaderboard data with current user
  const combinedLeaderboard = useMemo(() => {
    const realLeaderboard = leaderboardData.map((u: LeaderboardUser) => ({
      ...u,
      avatarSeed: u.avatarSeed || '👑',
      clickRate: u.clickRate || 0
    }));

    const userInList = realLeaderboard.find(u => u.username === currentProfile.username);
    if (userInList) {
    ...
    const userList = [...realLeaderboard, {
      username: currentProfile.username,
      tier: currentProfile.tier,
      points: 0,
      referralsCount: userReferrals,
      revenueGenerated: Math.round(userRevenue),
      avatarSeed: '👑',
      clickRate: userClickRate
    }];

    return userList
      .sort((a, b) => b.referralsCount - a.referralsCount || b.revenueGenerated - a.revenueGenerated)
      .map((u, idx) => ({ ...u, rank: idx + 1 }));
  }, [leaderboardData, currentProfile.username, currentProfile.tier, activeReferralsCount, waitlistReferralsCount, grossLtvRevenue, totalClicks]);
      ...
      <aside id="sidebar-left" className={`w-64 shrink-0 hidden md:flex flex-col justify-between z-10 ${sidebarBg} transition-all duration-300`}>
        ...
        <div className="flex-1 py-7 px-4 space-y-1.5 overflow-y-auto no-scrollbar">
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold tracking-wide transition-all duration-200 ${activeTab === 'home'
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold tracking-wide transition-all duration-200 ${activeTab === 'referrals'
              ? 'bg-orange-500 text-white shadow-[0_4px_12px_rgba(249,115,22,0.2)]'
              : `${isDark ? 'text-zinc-400 hover:text-white hover:bg-zinc-900/50' : 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100'}`
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold tracking-wide transition-all duration-200 ${activeTab === 'earnings'
              ? 'bg-orange-500 text-white shadow-[0_4px_12px_rgba(249,115,22,0.2)]'
              : `${isDark ? 'text-zinc-400 hover:text-white hover:bg-zinc-900/50' : 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100'}`
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold tracking-wide transition-all duration-200 ${activeTab === 'campaigns'
              ? 'bg-orange-500 text-white shadow-[0_4px_12px_rgba(249,115,22,0.2)]'
              : `${isDark ? 'text-zinc-400 hover:text-white hover:bg-zinc-900/50' : 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100'}`
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold tracking-wide transition-all duration-200 ${activeTab === 'copilot'
              ? 'bg-orange-500 text-white shadow-[0_4px_12px_rgba(249,115,22,0.2)]'
              : `${isDark ? 'text-zinc-400 hover:text-white hover:bg-zinc-900/50' : 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100'}`
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold tracking-wide transition-all duration-200 ${activeTab === 'leaderboard'
              ? 'bg-orange-500 text-white shadow-[0_4px_12px_rgba(249,115,22,0.2)]'
              : `${isDark ? 'text-zinc-400 hover:text-white hover:bg-zinc-900/50' : 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100'}`
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold tracking-wide transition-all duration-200 ${activeTab === 'assets'
              ? 'bg-orange-500 text-white shadow-[0_4px_12px_rgba(249,115,22,0.2)]'
              : `${isDark ? 'text-zinc-400 hover:text-white hover:bg-zinc-900/50' : 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100'}`
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold tracking-wide transition-all duration-200 ${activeTab === 'training'
              ? 'bg-orange-500 text-white shadow-[0_4px_12px_rgba(249,115,22,0.2)]'
              : `${isDark ? 'text-zinc-400 hover:text-white hover:bg-zinc-900/50' : 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100'}`
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-3.5 py-3 rounded-xl text-xs font-semibold tracking-wide transition-all duration-200 ${activeTab === 'settings'
              ? 'bg-orange-500 text-white shadow-[0_4px_12px_rgba(249,115,22,0.2)]'
              : `${isDark ? 'text-zinc-400 hover:text-white hover:bg-zinc-900/50' : 'text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100'}`
              }`}
          >
        ...
        <div className={`p-4 border-t ${isDark ? 'border-zinc-900 bg-[#0d0d10]' : 'border-zinc-100 bg-zinc-50/70'} space-y-3.5`}>
          ...
          {showAvatarUploader && (
            <div className={`p-3 rounded-xl border mt-2 space-y-2.5 transition-all duration-300 animate-fade-in ${isDark ? 'bg-black/40 border-zinc-900' : 'bg-white border-zinc-200 shadow-md'
              }`}>
              ...
              <div
                ...
                className={`border-2 border-dashed rounded-lg p-3 text-center cursor-pointer transition-all ${isAvatarDragging
      ...
      <div className={`flex-1 flex flex-col min-h-screen overflow-y-auto ${mainWorkspaceBg} transition-all duration-300`}>
        ...
        <header id="dashboard-header" className={`h-16 px-8 flex items-center justify-between sticky top-0 backdrop-blur z-20 ${headerBg} transition-all duration-200`}>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className={`hidden sm:flex items-center space-x-1.5 text-[9px] font-mono tracking-wider font-semibold uppercase px-2.5 py-1 rounded-full border ${isSupabaseConfigured()
              ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20'
              : 'bg-orange-500/10 text-orange-400 border-orange-500/20'
              }`}>
              <span className={`w-1.5 h-1.5 rounded-full ${isSupabaseConfigured() ? 'bg-emerald-400 animate-pulse' : 'bg-orange-400'
                }`} />
        ...
        <div id="mobile-nav" className="md:hidden flex px-6 py-2.5 border-b border-zinc-200 dark:border-zinc-900 bg-white dark:bg-zinc-900 overflow-x-auto gap-1 no-scrollbar">
          {['home', 'referrals', 'earnings', 'campaigns', 'copilot', 'leaderboard', 'settings'].map((tab) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-[10px] font-mono whitespace-nowrap font-bold tracking-wide uppercase ${activeTab === tab
        ...
        <main className="p-8 space-y-8 flex-1">
          ...
          {activeTab === 'home' && (
            <div className="space-y-8">
              ...
              <div className={`p-5 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 transition-all ${isDark ? 'bg-[#15151a] border border-[#272731]' : 'bg-orange-500/5 border border-orange-500/10'
                }`}>
                <div className="space-y-1">
                    ...
                    <div className="divide-y divide-zinc-200/50 dark:divide-zinc-900 bg-white dark:bg-transparent">
                      {milestones.map((mil) => (
                        <div key={mil.id} className="grid grid-cols-8 items-center text-xs">
                          ...
                          {/* Left Title block */}
                          <div className={`p-3.5 border-r border-zinc-200/50 dark:border-zinc-850 font-sans space-y-0.5 ${isDark ? 'bg-[#0d0d10]' : 'bg-zinc-50/50'
                            }`}>
                          ...
                          <div className="col-span-7 p-3 relative h-full flex items-center">
                            ...
                            <div
                              className={`absolute h-8 rounded-xl flex items-center justify-between px-3 text-[9px] font-bold text-white shadow-sm ring-1 ring-white/10 ${mil.id === 1 ? 'bg-indigo-600/80' :
                ...
                <div id="roadmaps-broadcasts" className={`p-6 rounded-2xl space-y-4 ${cardBg}`}>
                  ...
                  {broadcastsList.slice(0, 1).map((b) => (
                    <div key={b.id} className="space-y-2.5">
                      ...
                      <p className={`text-xs leading-relaxed pb-3 border-b border-zinc-200/50 dark:border-zinc-900 ${isDark ? 'text-zinc-400' : 'text-zinc-650'
                        }`}>{b.content}</p>
                    ...
                    <tbody className={`divide-y text-xs ${isDark ? 'divide-zinc-900 text-zinc-300' : 'divide-zinc-100 text-zinc-700'}`}>
                      {referrals.map((ref) => (
                        <tr key={ref.id} className="hover:bg-zinc-500/5 transition-colors">
                          ...
                          <td className="p-4">
                            <span className={`px-2 py-0.5 rounded-full text-[9px] font-mono font-bold ${ref.status === 'Active Subscriber'
                        ...
                        {generatedLeaderboardUsers.slice(0, 50).map((user) => {
                          ...
                          return (
                            <tr
                              ...
                              data-tier={user.tier}
                              className={`leaderboard-row transition-all duration-150 hover:bg-zinc-500/5 ${isMainUser
                                ? 'bg-orange-500/[0.08] dark:bg-orange-500/15 border-y-2 border-orange-500/30'
                                : ''
                                }`}
                            >
                              <td className="p-4 font-mono font-bold">
                                <span className={`px-2 py-0.5 rounded font-mono font-bold text-[11px] ${user.rank === 1 ? 'text-yellow-400 bg-yellow-400/5' :
                              ...
                              <td className="p-4">
                                <span className={`px-2 py-0.5 rounded text-[9px] font-mono block w-max uppercase font-bold border ${user.tier === 'Founding Ambassador'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                  ...
                  <div className={`flex flex-col justify-between p-5 rounded-2xl min-h-[300px] ${cardInnerBg}`}>
                    <div className="space-y-4">
                      ...
                      {generatedAiContent ? (
                        <div className={`text-xs font-sans leading-relaxed whitespace-pre-wrap select-all p-4 border rounded-xl ${isDark ? 'text-zinc-300 bg-black/40 border-zinc-800' : 'text-zinc-800 bg-white border-zinc-150'
                          }`}>
                          {generatedAiContent}
                        </div>
                      ) : (
          ...
          {activeTab === 'assets' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Asset 3 */}
                <div className={`p-5 rounded-2xl space-y-4 ${cardBg}`}>
                  <div className={`h-32 rounded-xl flex flex-col justify-center items-center text-center p-4 border ${isDark ? 'bg-zinc-950 border-zinc-900' : 'bg-zinc-50 border-zinc-100'
                    }`}>
          ...
          {activeTab === 'settings' && (
            <div className="space-y-6 animate-fade-in">
              <div className={`p-6 rounded-2xl max-w-2xl space-y-6 ${cardBg}`}>
                ...
                <div className={`p-4 rounded-xl border flex flex-col md:flex-row items-center justify-between gap-6 ${isDark ? 'bg-black/30 border-zinc-900' : 'bg-zinc-50 border-zinc-150'
                  }`}>
                  <div className="flex items-center gap-4">
                    {currentProfile.avatarUrl ? (
                      ...
                      <div className={`w-16 h-16 rounded-2xl flex items-center justify-center font-mono font-bold text-xl ${isDark ? 'bg-zinc-900 border border-zinc-800 text-orange-400' : 'bg-orange-100 border border-orange-200 text-orange-750'
                        }`}>
                        {currentProfile.fullName.charAt(0)}
                      </div>
                    )}
                  ...
                  <div className="w-full md:w-auto shrink-0 flex flex-col gap-2">
                    <div
                      ...
                      className={`border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-all w-full md:w-56 ${isAvatarDragging
                        ? 'border-orange-500 bg-orange-500/5'
                        : isDark
                ...
                <div className="space-y-5">
                  ...
                  <div className={`flex items-center justify-between p-4 rounded-xl border ${isDark ? 'bg-black/40 border-zinc-900' : 'bg-zinc-50 border-zinc-150'
                    }`}>
                    <div className="space-y-0.5">

...
import { Mail, ShoppingCart, TrendingUp, Users, ChevronRight, Monitor, ShoppingBag, Globe } from "lucide-react";
...
const PROD_ICONS: Record<string, React.ElementType> = { monitor: Monitor, bag: ShoppingBag, globe: Globe };
...
export function WinbackLeaderboard() {
  return (
    <section className="glass-card p-5">
      <header className="mb-4 flex items-center gap-2">
        <span

...
const config = {
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n}\n\n// Enterprise User Model\nmodel User {\n  id        String   @id @default(uuid()) // Generates an unguessable secure UUID string automatically\n  fullName  String\n  email     String   @unique // Enforces that no two users can register with the same email\n  password  String // Will store our encrypted bcrypt hash\n  createdAt DateTime @default(now()) // Automatically tracks account creation time\n  updatedAt DateTime @updatedAt // Automatically changes whenever a record is modified\n\n  @@map(\"users\") // Tells PostgreSQL to name the actual table \"users\" in lowercase\n}\n"
}
